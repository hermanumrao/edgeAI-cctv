...
int main(int argc, char* argv[]) {
    ...
    while (true) {
        ...
        std::vector<float> input_tensor = preprocess(frame, model_width, model_height);
        ...
        auto boxes = decode_output(output_data, conf_threshold, 6,
                                   frame.cols, frame.rows, model_width, model_height);

        draw_boxes(frame, boxes, conf_threshold);
